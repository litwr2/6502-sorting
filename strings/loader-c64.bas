10 rem v5, c64 basic
20 dim aa$(4000):sx=27:dim ss(sx):sp=sx:sd=-2:u=8
...
70 print"4. non-recursive quicksort in basic"
80 print"0. exit"
90 inputk$
100 k=val(k$):c=1:if k=0 then end
110 if k=1 thenk$="ultra"
120 if k=2 thenk$="lightning"
130 if k=3 thenk$="enhanced"
140 if k=4 thenc=0:goto240
150 if k>4 goto30
160 print"loading the sort routine..."
170 open8,u,8,k$+"sort,p,r"
180 i=49152:get#8,k$:get#8,k$
190 get#8,k$
200 if k$="" then k$=chr$(0)
210 pokei,asc(k$):i=i+1:if st<>0 goto230
220 goto190
230 close8:print "the sort routine is loaded"
240 input"number of strings to sort (0-back)";k$:n=val(k$)
250 if (n<0)or(n>4000) goto240
260 if n=0 goto30
...
500 print"sorting..."
510 gosub900:t1=ti
520 if c=1 then i=peek(83):sys49152,n,aa$(1):poke83,i
...
680 if k$="b" goto300
690 goto660
900 t2=0:pl=0:pu=0:pj=0:p1=0:x$=""
910 return
