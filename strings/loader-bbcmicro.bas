...
5270 GOTO5010
6000 PRINT"LOADING THE RELOCATOR..."
6010 C=OPENIN("QRELOC"):I%=HIMEM
6020 REPEAT ?I%=BGET#(C):I%=I%+1:PRINT;I%-HIMEM;CHR$(11):UNTIL EOF#(C)
6030 CLOSE#C:PRINT"LOADING THE SORT ROUTINE..."
6040 DIM Q% 617
6050 C=OPENIN("EQSORT"):I%=Q%
6060 REPEAT ?I%=BGET#(C):I%=I%+1:PRINT;I%-Q%;CHR$(11):UNTIL EOF#(C)
6070 CLOSE#C:I%=HIMEM
6080 CALL HIMEM,I%,Q%
6090 RETURN
